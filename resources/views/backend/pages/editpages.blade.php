		...
		<div class="col-sm-12">
            ...
            <input type="hidden" name="pageid" value="{{$data->pageid}}"/>
					...
					<div class="col-sm-9">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="Enter title here" id="page_title" value="{{$data->title}}">				
						</div>	
						<div class="form-group">	
					...
					<div class="col-sm-3">
						...
						<p><label for="{{$cat->cid}}"><input type="checkbox" name="category_id[]" value="{{$cat->cid}}" @if(in_array($cat->cid,$pagecat)) checked @endif> {{$cat->title}}</label></p>
							@endforeach
