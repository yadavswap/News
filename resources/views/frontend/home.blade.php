              ...
              <div class="flex flex-wrap -m-4">
                <div class="p-4 md:w-1/3">
                  <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                    <img class="lg:h-48 md:h-36 w-full object-cover object-center" href="{{url('article')}}/{{$l->pid}}" src="{{url('/posts')}}/{{$l->image}}" width="500px" height="500px">
                    <div class="p-6">
                      ...
                      <p class="leading-relaxed mb-3">{!! substr($l->description,0,300)!!}</p>
